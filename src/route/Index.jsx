...
import CacheManagementPage from "../pages/main/dashboard/settings/CacheManagement";
...
import AirtimeEpinTransactionsPage from "../pages/main/dashboard/transactions/airtime-epin";
    ...
    <>
      ...
      <Route element={<ProtectedRoute />}>
        <Route path={`/`} element={<Layout />}>
          ...
          <Route path="transactions/airtime-epin" element={<AirtimeEpinTransactionsPage />} />
          <Route path="transactions/data-epin" element={<DataEpinTransactionsPage />} />
          ...
          <Route path="service-providers/api-discounts/:providerName" element={<ServiceProvidersApiDiscounts />} />

          <Route path="services" element={<ServicesPage />} />
          <Route path="services/api/:serviceName" element={<ServicesApiDiscounts />} />
