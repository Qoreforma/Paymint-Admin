...
import { WalletAmountStatsCard, WalletStatsCard } from "./stats-card";
      ...
      {showStats &&
        (fetchingOverview ? (
          ...
          <Row className="mb-5">
            ...
            <Col lg={7}>
              <WalletStatsCard
                tradeTypeData={walletTxnsOverview?.data?.overview?.typeBreakdown?.find((stat) => stat?._id === type)}
                data={walletTxnsOverview?.data?.overview?.totals}
              />
            </Col>
          </Row>
        ))}
                      ...
                      return (
                        <DataTableItem key={item?._id} className="text-secondary">
                          ...
                          <DataTableRow>
                            ...
                            >
                              <span className="ccap">
                                {item?.status === "PENDING_MANUAL" ? "Pending Man" : item?.status}
                              </span>
                            </Badge>
                          </DataTableRow>
                          <DataTableRow className="nk-tb-col-tools">
          ...
          <div className="nk-tnx-details mt-sm-3">
            <Row className="gy-2">
              ...
              {/* <Col size={4}>
                ...
                <span className="caption-text">{formatter("NGN").format(formData.cashback ?? 0)}</span>
              </Col> */}
              <Col size={4}>
