...
const WalletBonusListPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="Bonus Transactions"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle>Bonus Transactions</BlockTitle>
            </BlockHeadContent>
          </BlockBetween>
        </BlockHead>

        <WalletTxnTable showStats type={"bonus"} data={data?.data} isLoading={isLoading} />
      </Content>
    </React.Fragment>
  );
};

export default WalletBonusListPage;
