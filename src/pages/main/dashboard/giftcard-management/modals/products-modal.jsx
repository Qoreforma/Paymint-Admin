...
const GiftcardProductModal = ({ categoryId, modal, closeModal, formData, setFormData }) => {
  const { mutate: createProduct, isSuccess: created } = useCreateGiftcardProduct();
  const { mutate: editProduct, isSuccess: edited } = useEditGiftcardProduct(categoryId || "");
