...
const FAQsPage = () => {
  ...
  const { isLoading, data: faqs } = useGetFaqs(currentPage, itemsPerPage, search, category);
      ...
      <Content>
        ...
        <Block>
          <FaqTable
            ...
            dataKeys={["question", "categoryName", "answer", "createdAt"]}
            modelOpen={setView}
              ...
              <div className="mt-4">
                <Row className="gy-3">
                  ...
                  <Col lg={6}>
                    ...
                    <span className="caption-text">{formatDateWithHyphen(formData.createdAt)}</span>
                  </Col>
                </Row>
              </div>
            </div>
