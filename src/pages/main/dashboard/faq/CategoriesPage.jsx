...
const FaqCategoriesPage = () => {
  ...
  const onFormSubmit = (form) => {
    ...
    const submittedData = {
      name: form.name,
      isActive: form.status === "Active" ? true : false,
    };
        ...
        <UncontrolledDropdown>
          ...
          <DropdownMenu end>
            <ul className="link-list-opt no-bdr">
              {hasPermission("faqs_categories.update") && (
                <li>
                  <DropdownItem
                    tag="a"
                    href="#"
              ...
              {hasPermission("faqs_categories.delete") && (
                <li>
                  <DropdownItem
                    tag="a"
                    href="#"
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            ...
            <BlockHeadContent>
              {hasPermission("faqs_categories.create") && (
        ...
        <Block>
          <FaqTable
            ...
            headers={["name", "faq count", "date", "status"]}
            dataKeys={["name", "faqCount", "createdAt", "isActive"]}
            modelOpen={setView}
              ...
              <div className="custom-control-sm custom-switch">
                <input
                  ...
                  onClick={() => {
                    ...
                    setEditedId(id);
                    toggleCategory({ isActive: !status });
                  }}
                  id={id}
                />
                <label className="custom-control-label" htmlFor={id}>
                  <span className={`ccap fw-medium ${status ? "text-success" : "text-muted"}`}>
