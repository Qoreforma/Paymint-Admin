...
import { formatDateWithTime, tableNumbers } from "../../../../utils/Utils";
...
const ServiceProvidersApiDiscounts = () => {
  ...
  const { isLoading, data } = useGetApiDiscounts({ currentPage, size: itemsPerPage, providerId });
  const { mutate: updateDiscount } = useUpdateApiDiscount();
  ...
  return (
    <React.Fragment>
      <Head title={`${providerName} API Discounts`}></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>{providerName} API Discounts</BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
...
export default ServiceProvidersApiDiscounts;
