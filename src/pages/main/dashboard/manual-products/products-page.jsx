  ...
  return (
    <React.Fragment>
      ...
      <Content>
                      ...
                      {products?.data?.map((item, idx) => {
                        return (
                          <DataTableItem key={item.id} className="text-secondary">
                            ...
                            <DataTableRow>
                              <span className="">{item.product_type}</span>
                            </DataTableRow>
                            <DataTableRow>
                            ...
                            <DataTableRow>
                              <div className="custom-control-sm custom-switch">
                                ...
                                <label className="custom-control-label" htmlFor={item.id}>
                                  <span className={`ccap fw-medium ${item?.active ? "text-success" : ""}`}>
        ...
        <AddProductModal modal={view.add} closeModal={() => onFormCancel()} />
        {/* ADD CATEGORIES */}
