...
const CryptoAssetsPage = () => {
  ...
  const handleRowClick = (itemId, e) => {
    ...
    // If in multiple selection mode, toggle the checkbox
    if (multiple) {
      const checkbox = e.currentTarget.querySelector(".custom-control-input");
      if (checkbox) {
    ...
    // Open the view modal (same as View button behavior)
    onEditClick(itemId);
  };
  ...
  console.log({ multiple: multiple, selected: selected });
          ...
          <Block className={"mb-2"}>
            ...
            {selected?.length > 0 && (
              <>
                ...
                {hasPermission("crypto_buy.manage") && (
                  <Button
                    className={"btn-round ms-2"}
                    onClick={() => {
                      setShowMultiple(true);
                        ...
                        return (
                          ...
                          >
                            ...
                            <DataTableRow>
                              <div className="custom-control-sm custom-switch" onClick={(e) => e.stopPropagation()}>
                                <input
                                  ...
                                  className="custom-control-input"
                                  name={item.name}
                                  disabled={!hasPermission("crypto_sell.manage")}
                            ...
                            <DataTableRow>
                              <div className="custom-control-sm custom-switch" onClick={(e) => e.stopPropagation()}>
                                <input
                                  disabled={!hasPermission("crypto_buy.manage")}
                                  type="checkbox"
                                  className="custom-control-input"
                                  name={item.name}
