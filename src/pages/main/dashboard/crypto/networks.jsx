...
const CryptoNetworkPage = () => {
  ...
  // Handle row click to navigate to network details page
  const handleRowClick = (itemId, e) => {
    // Prevent navigation if clicking on interactive elements (dropdowns, buttons, etc.)
    ...
    // Navigate to network details page (same as View button behavior)
    navigate(`/network-details/${itemId}`);
  };
                                  ...
                                  <UncontrolledDropdown>
                                    ...
                                    <DropdownMenu end>
                                      <ul className="link-list-opt no-bdr">
                                        ...
                                        {hasPermission("crypto.update_network") && (
                                          <li>
                                            <DropdownItem
                                              tag="a"
                                              href="#edit"
                                        ...
                                        {hasPermission("crypto.delete_network") && (
                                          <li>
                                            <DropdownItem
                                              tag="a"
                                              href="#edit"
