...
const AirtimeEpinTransactionsPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="Airtime Epin Transaction"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle>Airtime Epin Transactions</BlockTitle>
            </BlockHeadContent>
          </BlockBetween>
        </BlockHead>
...
export default AirtimeEpinTransactionsPage;
