...
export const useToggleHottest = (editedId, categoryId) => {
  const queryClient = useQueryClient();
  ...
  return useMutation(
    (data) =>
      toast.promise(
        instance
          .put(BACKEND_URLS.giftcard_product + `/${editedId}/hottest`, data)
          .then((res) => res.data)
          .catch((err) => {
            throw err.response.data;
          }),
...
export const useBulkUpdateGiftcardCommission = (categoryId) => {
  const queryClient = useQueryClient();
  ...
  return useMutation(
    (data) =>
      toast.promise(
        instance
          .put(BACKEND_URLS.giftcard_product + `/bulk/commission`, data)
          .then((res) => res.data)
          .catch((err) => {
            throw err.response.data;
          }),
        {
          success: (data) => data.message || "Commissions updated successfully.",
          loading: "Please wait...",
...
export const useBulkUpdateHottest = (categoryId) => {
  const queryClient = useQueryClient();
  ...
  return useMutation(
    (data) =>
      toast.promise(
        instance
          .put(BACKEND_URLS.giftcard_product + `/bulk/hottest`, data)
          .then((res) => res.data)
          .catch((err) => {
            throw err.response.data;
          }),
        {
          success: (data) => data.message || "Giftcards updated successfully.",
          loading: "Please wait...",
          error: (error) => error?.message || "Something went wrong",
        },
        {
