  ...
  return useQuery(
    ...
    async () => {
      const request = await instance
        .get(BACKEND_URLS.banners + `?page=${page}&limit=${limit}`)
        .then((res) => res?.data)
        .catch((err) => {
...
export const useToggleBanners = (id) => {
  ...
  return useMutation(
    (data) =>
      toast.promise(
        instance
          .put(BACKEND_URLS.banners + `/${id}/status`, data)
          .then((res) => res.data)
          .catch((err) => {
            throw err.response.data;
          }),
...
export const useEditBanners = (id) => {
  const queryClient = useQueryClient();
...
export const useReorderBanners = () => {
  ...
  return useMutation(
    (data) =>
      toast.promise(
        instance
          .put(BACKEND_URLS.banners + `/reorder`, data)
          .then((res) => res.data)
          .catch((err) => {
            throw err.response.data;
          }),
